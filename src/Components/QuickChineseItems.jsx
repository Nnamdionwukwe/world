...
export default function QuickChineseItems({ quick, handleSelectId }) {
  const { dishName, price, image, note } = quick;

  return (
    <li onClick={() => handleSelectId(quick)} className={styles.saladMainLi}>
