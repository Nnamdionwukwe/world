...
export default function GrillHouseItem({ grill, handleSelectId }) {
  const { dishName, price, image, note } = grill;

  return (
    <li onClick={() => handleSelectId(grill)} className={styles.saladMainLi}>
